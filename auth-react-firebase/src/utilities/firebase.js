...
const firebase = { rtdb , fbauth , auth , db };
export default firebase;
/*
fbauth.createUserWithEmailAndPassword(auth, "email@udel.edu", "email@udel.edu").catch(function(error) {
...
function signInUser (email, password) {
  ...
  fbauth.signInWithEmailAndPassword(auth, email, password).then(data=>{
...
function createUser(email,password,username){
    ...
    fbauth.createUserWithEmailAndPassword(auth,email,password).catch(function(error) {
        const errorCode = error.code;
        const errorMessage = error.message;
        console.log(errorCode);
        console.log(errorMessage);
